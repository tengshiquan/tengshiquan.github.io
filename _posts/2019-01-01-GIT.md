...
![image-20191113143216690](/img/2019-01-01-GIT.assets/image-20191113143216690.png)
...
```
恢复至git里最新的版本,  if (index has file) {always from index} else {from HEAD}
...
<img src="/img/2019-01-01-GIT.assets/Graphical_Git_Diff.png" alt="Picture"  />
...
![img](/img/2019-01-01-GIT.assets/2147642-42195cacced56729.png)

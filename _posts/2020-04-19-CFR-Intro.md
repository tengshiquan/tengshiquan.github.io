...
The **average strategy** that is computed by regret matching is the strategy that **minimizes regret against the opponent’s fixed strategy**. In other words, it is a **best response** to their strategy.
